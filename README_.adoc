...
在项目开发环境配置 peacetrue-logger-compiler（TODO 此名称可优化）
插件，自动启用日志代理功能，可直接在源码中调用日志：

[source,javascript]
----
import {contextLogger} from "peacetrue-logger";
contextLogger()?.info('some message');
----
...
peacetrue-logger-compiler 的 vite 版本。
